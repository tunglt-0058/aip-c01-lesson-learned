...
> Keo dán hệ thống: điều phối workflow, hàng đợi, API, cấu hình động cho ứng dụng GenAI.
...
```mermaid
mindmap
  root((06. Integration & Orchestration Services))
    «service A»
    «service B»
    «service C»
```
...
|---|---|---|
| «Lambda, Step Functions, API Gateway, AppSync, EventBridge, SQS, SNS, AppConfig» | «...» | «...» |
...
Nhóm này phủ mạnh: **D2 (chính), D1, D4**. Xem [bản đồ cross-map](./README.md#bản-đồ-nhóm-service--5-exam-domain).
