...
> Nhóm dịch vụ để tùy chỉnh, huấn luyện, đăng ký phiên bản và vận hành model (MLOps/GenAIOps).
...
|---|---|---|
| «SageMaker AI, Model Registry, Pipelines, Data Wrangler, Processing, Model Monitor, Clarify, JumpStart» | «...» | «...» |
...
Nhóm này phủ mạnh: **D1, D2, D5**. Xem [bản đồ cross-map](./README.md#bản-đồ-nhóm-service--5-exam-domain).
